...
global N,N1,u,v,w,f_b,h,tau,rho,lm,lm2,rho2
...
for p2 in range(4,5):
    ...
    def initial_guess():
        ...
        # reading data file
        tau2 = int(np.around(tau1[p2]*(10**10),decimals=0))
    ...
    def fun_lambda(bx,by,bz,bext):
        ...
        lm = 1.5*.001*(bx2p*bx2p + by2p*by2p + bz2p*bz2p)/tau**2 -1*tau
