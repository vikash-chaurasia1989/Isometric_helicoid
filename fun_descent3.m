...
%    %=====================================================
  ...
  p = 2;
        ...
        f_b(3*p-5,1) = fac*bx4p(p-1,1)   + (bx(p,1)-bx0(p,1))/c/ht ;
        f_b(3*p-4,1) = fac*by4p(p-1,1)   + (by(p,1)-by0(p,1))/c/ht ;
        f_b(3*p-3,1) = fac*bz4p(p-1,1)   + (bz(p,1)-bz0(p,1))/c/ht ;  
...
%   
  ...
  jac(ind,ind)     = id*(6*fac/h^4   + 1/c/ht) ;  
