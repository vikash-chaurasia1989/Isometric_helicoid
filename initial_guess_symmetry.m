function x =   initial_guess_symmetry()
...
% % % 
%  strb =   'b_branch_3_N336_symmetric.txt';% 'b_branch_2_N240_symmetric.txt';%  
% % 
%  N = 336;
% temp = load([path strb]);
% 
...
% % % % % % %
  ...
  str0=    'branch_3_N336_tau_153797061627_symmetry.txt';%'branch_2_N120_tau_119842500480_symmetry.txt';%  'branch_2_N120_tau_119843000480_symmetry.txt';
 
  temp = load([path str0]);

  x(1:5*N1+4,1) = temp(1:5*N1+4,1);
%
% % % f(3*N1+1,1) = 0;
% % %  f(4*N1 ,1) = 0;
% % %f(5*N1+2,1) = 0;
