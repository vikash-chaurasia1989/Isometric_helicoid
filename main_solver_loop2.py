...
#=== Initialization
#N = 240
tau1 = np.arange(15.46,16.1,.1)
#tau1 = np.arange(20,25,.1)
...
for p2 in range(0,1):
    ...
    def initial_guess():
        ...
        if(p2==0):
            str0 = '7pi_knot_49_tau_154.6.txt'
        else:
            str0 = '7pi_knot_N49_tau_' + str(tau2) + '.txt'
    ...
    #x2 = optimize.least_squares(fun_curve,x0,method = 'lm', jac = fun_jac,verbose=2 )
    #===============================================================================
    #======================    Post processing ======================================
    #===============================================================================
