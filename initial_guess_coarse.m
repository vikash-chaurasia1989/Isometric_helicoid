       function f =   initial_guess_coarse()
 
  %-- this file reads data and coarse it using linear interpolation 
 ...
 %--- This file only uses saved data for initial guess 
   %  
   str0 = '7pi_knot_168_tau_154.5269_1.txt';
   str0 ='7pi_knot_168_tau_153.9778.txt';
