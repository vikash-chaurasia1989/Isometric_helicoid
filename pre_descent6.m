function [] = pre_descent6()

global N fac tau branch bx by bz id k strpath path 
...
%=== getting rid of the lagrange multipliers entry in f1 
...
for i = 1:k 
    ...
    f2(3*N1+indv,1) = V1(1:3*N1,I(i))./sqrt(sum(V1(1:3*N1,I(i)).^2));   
end
